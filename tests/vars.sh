...
# Latest DB engine version available in PREVIOUS_PXC_OPERATOR_VERSION
export PREVIOUS_PXC_DB_ENGINE_VERSION=${PREVIOUS_PXC_DB_ENGINE_VERSION:-"8.0.39-30.1"}
echo "PREVIOUS_PXC_DB_ENGINE_VERSION=${PREVIOUS_PXC_DB_ENGINE_VERSION}"

export PSMDB_OPERATOR_VERSION=${PSMDB_OPERATOR_VERSION:-"1.19.1"}
echo "PSMDB_OPERATOR_VERSION=${PSMDB_OPERATOR_VERSION}"

export PSMDB_DB_ENGINE_VERSION=${PSMDB_DB_ENGINE_VERSION:-"7.0.15-9"}
echo "PSMDB_DB_ENGINE_VERSION=${PSMDB_DB_ENGINE_VERSION}"

# Latest DB engine version available in PREVIOUS_PSMDB_OPERATOR_VERSION
export PREVIOUS_PSMDB_DB_ENGINE_VERSION=${PREVIOUS_PSMDB_DB_ENGINE_VERSION:-"7.0.8-5"}
...
# Latest DB engine version available in PREVIOUS_PG_OPERATOR_VERSION
export PREVIOUS_PG_DB_ENGINE_VERSION=${PREVIOUS_PG_DB_ENGINE_VERSION:-"16.4"}
...
export PREVIOUS_PSMDB_OPERATOR_VERSION=${PREVIOUS_PSMDB_OPERATOR_VERSION:-"1.18.0"}
echo "PREVIOUS_PSMDB_OPERATOR_VERSION=${PREVIOUS_PSMDB_OPERATOR_VERSION}"

## ============== K3D cluster configuration ===================
export KUBECONFIG="${KUBECONFIG:-${OPERATOR_ROOT_PATH}/tests/kubeconfig}"
