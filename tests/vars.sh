...
export OPERATOR_BIN_DIR=${OPERATOR_BIN_DIR:-"${OPERATOR_ROOT_PATH}/bin"}
echo "OPERATOR_BIN_DIR=${OPERATOR_BIN_DIR}"
...
export MINIO_BUCKET_NAME=${MINIO_BUCKET_NAME:-"everest-operator"}
