...
require (
	...
	github.com/VictoriaMetrics/operator/api v0.51.4-0.20250311150302-ee4a65be3599
	...
	github.com/percona/percona-postgresql-operator v0.0.0-20250307202154-0381fdb9d6e4
