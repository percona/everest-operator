...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataImportJobS3SourceRef) DeepCopyInto(out *DataImportJobS3SourceRef) {
	*out = *in
	if in.VerifyTLS != nil {
		in, out := &in.VerifyTLS, &out.VerifyTLS
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataImportJobS3SourceRef.
func (in *DataImportJobS3SourceRef) DeepCopy() *DataImportJobS3SourceRef {
	if in == nil {
		return nil
	}
	out := new(DataImportJobS3SourceRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DataImportJobSource) DeepCopyInto(out *DataImportJobSource) {
	*out = *in
	out.BackupStorageRef = in.BackupStorageRef
	if in.S3Ref != nil {
		in, out := &in.S3Ref, &out.S3Ref
		*out = new(DataImportJobS3SourceRef)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *DataImportJobSpec) DeepCopyInto(out *DataImportJobSpec) {
	*out = *in
	...
	if in.DataImportJobSpec_Common != nil {
		in, out := &in.DataImportJobSpec_Common, &out.DataImportJobSpec_Common
		*out = new(DataImportJobSpec_Common)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataImportJobSpec_Common) DeepCopyInto(out *DataImportJobSpec_Common) {
	*out = *in
	if in.DataImporterRef != nil {
		in, out := &in.DataImporterRef, &out.DataImporterRef
		*out = new(v1.LocalObjectReference)
		**out = **in
	}
	if in.Source != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataImportJobSpec_Common.
func (in *DataImportJobSpec_Common) DeepCopy() *DataImportJobSpec_Common {
	if in == nil {
		return nil
	}
	out := new(DataImportJobSpec_Common)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataImporter_DatabaseClusterConstraints) DeepCopyInto(out *DataImporter_DatabaseClusterConstraints) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataImporter_DatabaseClusterConstraints.
func (in *DataImporter_DatabaseClusterConstraints) DeepCopy() *DataImporter_DatabaseClusterConstraints {
	if in == nil {
		return nil
	}
	out := new(DataImporter_DatabaseClusterConstraints)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DatabaseClusterStatus) DeepCopyInto(out *DatabaseClusterStatus) {
	*out = *in
	...
	if in.DataImportJobRef != nil {
		in, out := &in.DataImportJobRef, &out.DataImportJobRef
		*out = new(v1.LocalObjectReference)
		**out = **in
	}
