...
type Versions struct {
	...
	Proxy  map[string]ComponentsMap `json:"proxy,omitempty"`
...
// RecommendedVersions returns the recommended versions for the components map.
// FIXME return error if no recommended version found?
func (c ComponentsMap) RecommendedVersions() []string {
	var versions []string
...
// FIXME return error if no recommended version found?
// FIXME also return available versions if there are no recommended versions
